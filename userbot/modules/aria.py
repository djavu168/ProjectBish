...
CMD_HELP.update({
    ...
    {
        ".aurl":
        "Downloads the file from URI into your userbot server storage.",

        ".amag":
        "Downloads the magnet link into your userbot server.",

        ".ator":
        "Downloads the torrent binary file from *.torrent file.",

        ".apause":
        "Pauses on-going downloads.",
