...
CMD_HELP.update({
    ...
    {
        ".purge":
        "Purges all messages starting from the reply."
    },
    "purgeme":
    {
        ".purgeme":
        "Deletes x amount of your latest messages.\n"
        "**Hints**:\n>`.purgeme 2`"
    },
    "del":
    {
    ...
    {
        ".edit":
        "Replace your last message with newmessage."
    },
    "sd":
    {
        ".sd":
        "Creates a message that selfdestructs in x seconds.\n"
        "**Hints**:\n>`.sd 2 bar`"
    }
})
